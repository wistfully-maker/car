...
# 停车检测
STOP_WIN_H = 10; STOP_WIN_W = 60; STOP_WHITE_THRESH = 0.35  # 平衡灵敏度和误触发
STOP_CONSECUTIVE = 1; STOP_DELAY = 2.0


class LineFollowerV20Left:
    def __init__(self):
...
if __name__=="__main__":
    rospy.init_node("line_follower_v20_left")
    LineFollowerV20Left()
    rospy.spin()
