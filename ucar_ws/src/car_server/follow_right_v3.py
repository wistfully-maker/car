...
class FollowRightV3:
    def __init__(self):
        rospy.init_node('follow_right_v3', anonymous=True)
        ...
        self.fc = 0
        rospy.loginfo("✅ follow_right_v3 | 检测方向0→接近拐角→旋转70°")
