...
char *buffer1;
bool if_print_proc_log = true;                                          // 是否打印log,调试用
bool if_save_record_file = true;                                         // 是否保存音频到本地
std::string USER_CONFIG_PATH = "/config/offline_QA.txt";                 // 离线问答对保存的地址
string appid = "2697a716";                                               // 仅用于在线AIUI，用户可修改，普通用户每天500次
string key = "424d575268594135073cbe862124f0b2";                         // AIUI引擎Appid对应的AppKey
string api_secret = "NmU5Yjg0YzJmOWFhODE0OTQyYjQ4YmUy";                  // AIUI引擎Appid对应的ApiSecret（v3协议云服务必须）
string offline_appid = "appid = 2697a716";					 //仅用于离线命令词识别I，用户可修改.
